...
- Lớp mới có giá trống/format VND, môn Tiếng Anh, bốn section và màu ổn định theo ID.
- Lịch dùng Xác nhận lịch dạy/Kiểm tra lịch tuần và vẫn dùng native date/time input.
- Password 6 ký tự, reset command, rate-limit/Retry-After countdown và strict port 5173 PASS.
- Không overflow ở 360, 390, 400, 430; desktop sidebar 1440 hoạt động.
- Targeted checks, integration, E2E, `check:full` một lần và package checks đều PASS.
