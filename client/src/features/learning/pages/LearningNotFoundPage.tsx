      ...
      <Box component="main" sx={{ minHeight: "calc(100dvh - 130px)", display: "grid", placeItems: "center", py: 5, background: "linear-gradient(145deg,#f2f9ff,#f8f2ff,#fff7df)" }}>
        <Container maxWidth="sm">
          <Stack spacing={2} sx={{ alignItems: "center", textAlign: "center", p: { xs: 3, sm: 5 }, border: "1px solid #ded2f5", borderRadius: "24px", bgcolor: "rgba(255,255,255,.9)", boxShadow: "0 14px 36px rgba(70,50,120,.1)" }}>
            <Box aria-hidden="true" sx={{ width: 76, height: 76, display: "grid", placeItems: "center", borderRadius: "24px", bgcolor: "#f2edff", color: "#7455d9" }}><SearchOff sx={{ fontSize: 38 }} /></Box>
            <Typography component="p" sx={{ color: "#7455d9", fontWeight: 800 }}>404 · GÓC HỌC</Typography>
            ...
            <Button component={Link} to="/hoc" variant="contained" startIcon={<ArrowBack />} sx={{ bgcolor: "#7455d9", borderRadius: 3 }}>Về góc học</Button>
          </Stack>
        </Container>
      </Box>
    </LearningShell>
