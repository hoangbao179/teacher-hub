...
export function BookShell({ children, readerMode = false }: PropsWithChildren<{ readerMode?: boolean }>) {
  return (
    <Box data-testid="book-shell" sx={{ minHeight: "100dvh", display: "flex", flexDirection: "column", overflowX: "clip", bgcolor: readerMode ? "#eef3f5" : "#f7fbfc", color: "#172238", "& > main": { flex: "1 0 auto" }, "& h1, & h2, & h3": { textWrap: "balance" }, "& p": { textWrap: "pretty" } }}>
