...
export function StickyActionBar({ children }: { children: ReactNode }) {
  return <Box data-testid="sticky-action-bar" sx={{ position: "sticky", bottom: { xs: "calc(var(--admin-nav-height) + var(--admin-safe-bottom) + 8px)", md: 16 }, zIndex: 10, bgcolor: "background.default", py: 1 }}>
