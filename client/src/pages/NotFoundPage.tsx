...
export function NotFoundPage({ admin = false }: { admin?: boolean }) {
  ...
  return <ThemeProvider theme={publicLearningTheme}>
    <Box component="main" sx={{ minHeight: "100dvh", display: "grid", placeItems: "center", overflowX: "clip", p: { xs: 2, sm: 3 }, background: "linear-gradient(145deg, #eaf5ff 0%, #f5fbfa 52%, #eaf8f3 100%)" }}>
      <Container maxWidth="sm">
        <Stack spacing={2.5} sx={{ alignItems: "center", textAlign: "center", p: { xs: 3, sm: 5 }, border: "1px solid #d5e5e3", borderRadius: 4, bgcolor: "rgba(255,255,255,.88)", boxShadow: "0 16px 40px rgba(20,40,64,.1)" }}>
          <Box aria-hidden="true" sx={{ position: "relative", width: 150, height: 92 }}>
            <Box sx={{ position: "absolute", left: 16, bottom: 5, width: 118, height: 62, bgcolor: "#fff8cf", border: "3px solid #0f766e", borderRadius: "8px 8px 16px 16px", transform: "rotate(-3deg)" }} />
