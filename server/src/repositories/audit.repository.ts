...
export type AuditAction =
  ...
  | "SCHEDULE_REPLACEMENT_SKIPPED" | "MAKEUP_ENTITLEMENT_OPENED" | "MAKEUP_ENTITLEMENT_RESERVED"
  | "MAKEUP_ENTITLEMENT_RELEASED" | "MAKEUP_ENTITLEMENT_FULFILLED" | "MAKEUP_ENTITLEMENT_WAIVED"
  | "BULK_TEMPORARY_RESCHEDULED" | "TUITION_ADVANCE_RECEIVED" | "TUITION_ADVANCE_ALLOCATED"
  | "TUITION_ADVANCE_TRANSFERRED" | "TUITION_ADVANCE_REFUNDED"
  | "TUITION_INCOMPLETE_SETTLED" | "TUITION_INCOMPLETE_WAIVED" | "ENROLLMENT_TRANSFERRED"
  | "TEACHER_BUSY_SLOT_CREATED" | "TEACHER_BUSY_SLOT_UPDATED" | "TEACHER_BUSY_SLOT_DELETED"
  | "LEGACY_IMPORT_APPLIED"
  | "STUDENT_GOOGLE_SHEET_CREATED" | "STUDENT_GOOGLE_SHEET_REGENERATED" | "STUDENT_GOOGLE_SHEET_ARCHIVED";

export interface AuditEntry {
  actorUserId?: number;
  action: AuditAction;
  entityType: "CLASS" | "STUDENT" | "ENROLLMENT" | "RECURRING_SCHEDULE" | "SCHEDULE_EXCEPTION" |
    "TEACHER_BUSY_SLOT" | "LESSON" | "TUITION_CYCLE" | "TUITION_RECEIPT" | "USER" | "LEGACY_IMPORT" |
