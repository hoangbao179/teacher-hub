...
function preview(rows: LegacyImportRowPreview[]): LegacyImportPreview {
  return {
    ...
    paymentEvents: [], tuitionCycles: [], tuitionCyclePlans: [], minimalLessonGroups: [], timeMappings: [], academicPeriods: [], classCandidates: [], rows,
    summary: { totalLessons: 0, presentLessons: 0, absentLessons: 0, academicPeriodCount: 0,
      completedCycleCount: 0, paidCycleCount: 0, freeLessonCount: 0, postPaidFreeLessonCount: 0,
      currentCycleProgress: 0, hasAdvancePayment: false,
